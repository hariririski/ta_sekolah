					...
					<div class="section-body">
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<?php foreach($edit_kelas as $data){ ?>
								 <?php
									echo form_open('Redirect_controller/proses_edit_kelas?id='.$data->id_kelas.'' , array('class' => 'form-horizontal'));    
								?>
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="Username6" name="kelas" value="<?php echo $data->nama_kelas; ?>" required	autofocus	><div class="form-control-line"></div>
												</div>
											</div>
											<div class="form-group">
												<label for="Username5" class="col-sm-2 control-label">Daya Tampung</label>
												<div class="col-sm-10">
													<input type="number" class="form-control" id="Username6" name="daya_tampung" value="<?php echo $data->daya_tampung; ?>"required	autofocus><div class="form-control-line"></div>
												</div>
											</div>
									...
									<table id="datatable1" class="table table-striped table-hover">
										...
										<tbody>
											...
											<tr class="gradeX">
												...
												<td><a href="<?php echo base_url()?>edit_efek?id=<?php echo $data->id_kelas?>"  ><button type="button" class="btn ink-reaction btn-raised btn-primary">Edit</button></a></td>
												<?php
