			...
			<div id="content">
				<section class="style-default-bright">
					<div class="section-header">
						<h2 class="text-primary">Edit Wali Kelas</h2>
					</div>
					<div class="section-body">
						...
						<div class="col-lg-12">
								<?php echo $this->session->flashdata('pesan');?>
								 ...
								 $TA=$_GET['TA'];
								 $id=rawurldecode($id);
									echo form_open("Redirect_controller/proses_edit_wali_kelas?id=$id&&TA=$TA", array('class' => 'form-horizontal'));    
								?>
									<div class="card">
										<div class="card-head style-primary">
											<header>Wali Kelas</header>
										</div>
										<div class="card-body">
											<?php
											...
											<div class="form-group">
														...
														<div class="col-sm-10">
														<label for="Username5"  class="form-control"><?php echo $nama_kelas ?></label>
											...
											<div class="form-group">
														...
														<option value="<?php echo $id_wali_kelas?>"><?php echo $data->nip?>/<?php echo $nama_wali_kelas?></option>
															<?php foreach($data_guru as $data){?>
													<option value="<?php echo $data->nip?>"><?php echo $data->nip?>/<?php echo $data->gelar_depan?><?php echo $data->nama_guru?><?php echo $data->gelar_belakang?></option>
													<?php }?>
														</select>
