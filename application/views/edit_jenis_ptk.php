					...
					<div class="section-body">
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<?php foreach($edit_jenis_ptk as $data){ ?>
								 <?php
									echo form_open('Redirect_controller/proses_edit_jenis_ptk?id='.$data->id_jenis_ptk.'', array('class' => 'form-horizontal'));    
								?>
									<div class="card">
										<div class="card-head style-primary">
											<header>Edit Jenis PTK</header>
										</div>
										<div class="card-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" value="<?php echo $data->nama_jenis_ptk; ?>"id="Username5" name="jenis_ptk" required autofocus><div class="form-control-line"></div>
												</div>
											</div>
