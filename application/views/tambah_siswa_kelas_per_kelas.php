					...
					<div class="section-body">
						...
						<div class="col-lg-12">
								<?php echo $this->session->flashdata('pesan');?>
								 ...
								 $kelas=$_GET['kelas'];
								 $wali=$_GET['id_wali'];
									echo form_open("Redirect_controller/proses_tambah_siswa_kelas_per_kelas?TA=$TA&&kelas=$kelas&&wali=$wali", array('class' => 'form-horizontal'));    
								?>
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="form-group">
														...
														<div class="col-sm-10">
														<label for="Username5" ><h4><b><?php echo $_GET['nama_kelas']; ?></b></h4></label>
											...
											<div class="form-group">
														...
														<div class="col-sm-10">
															<label for="Username5" ><h4><b><?php echo $_GET['namawali']; ?></b></h4></label>
