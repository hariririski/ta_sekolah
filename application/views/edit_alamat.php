								...
								<div class="card tabs-right style-default-light">
									...
									<div class="card-body tab-content style-default-bright">
										...
										<div class="tab-pane  <?php $link=$_GET['id']; if($link =="3"){ echo "active";} ?>" id="first3">
											<h3 class="text-light">Edit <strong>Kabupaten</strong></h3>
											<section class="style-default-bright">
													...
													<div class="row">
														<div class="col-lg-12">
															<?php echo $this->session->flashdata('pesan');?>
															 <?php
															 $cek_kabupaten=$_GET['id_kabupaten'];
																echo form_open("Redirect_controller/proses_edit_kabupaten/$cek_kabupaten", array('class' => 'form-horizontal'));    
															?>
															<?php
															$cek_kabupaten=$_GET['id_kabupaten'];
															if($cek_kabupaten>0){
																...
																<div class="card">
																	...
																	<div class="card-body">
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-10">
																				<input type="text" class="form-control" id="Username5" value="<?php echo $data->nama_kabupaten; ?>" name="nama_kabupaten" required autofocus><div class="form-control-line"></div>
																			</div>
																		</div>
															...
															<div class="table-responsive">
																<table <?php $link=$_GET['id']; if($link =="3"){ echo 'id="datatable1"';} ?> class="table table-striped table-hover">
																	...
																	<tbody>
																		<?php
																		$cek_kabupaten=$_GET['id_kabupaten'];
																		$cek_desa=$_GET['id_desa'];
																		if($cek_kabupaten>0 && $cek_desa==0){
												...
												<div class="section-body">
													...
													<div class="row">
														<div class="col-lg-12">
															<?php echo $this->session->flashdata('pesan');?>
															 <?php
															 $cek_kecamatan=$_GET['id_kecamatan'];
																		
																echo form_open("Redirect_controller/proses_edit_kecamatan/$cek_kecamatan", array('class' => 'form-horizontal'));    
															?>
																<div class="card">
																	<div class="card-head style-info">
																	...
																	<div class="card-body">
																		...
																		<div class="form-group">
																			...
																			<select  class="form-control" required="" aria-required="true" required name="kabupaten" data-live-search="true">
																				...
																				<?php foreach($kabupaten as $data2){
																					if($data->id_kabupaten!=$data2->id_kabupaten){  ?>
																				<option value="<?php echo $data2->id_kabupaten?>"><?php echo $data2->nama_kabupaten?></option>
																				<?php 
																					}}
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-10">
																				<input type="text" class="form-control" id="Username5" value="<?php echo $data->nama_kecamatan?>"name="nama_kecamatan" required autofocus><div class="form-control-line"></div>
																			</div>
																		</div>
												...
												<div class="section-body">
													...
													<div class="row">
														<div class="col-lg-12">
															<?php echo $this->session->flashdata('pesan');?>
															 <?php
																echo form_open("Redirect_controller/proses_edit_desa/$cek_desa", array('class' => 'form-horizontal'));    
															?>
																<div class="card">
																	<div class="card-head style-info">
																	...
																	<?php
																		...
																		<select id="kabupaten_desa"  class="form-control" required="" aria-required="true" required name="kabupaten" data-live-search="true">
																			    <option value="<?php echo $data->id_kabupaten?>"><?php echo $data->nama_kabupaten?></option>
																				<?php foreach($kabupaten as $data1){
																					if($data->id_kabupaten!=$data1->id_kabupaten){
																					?>
																				<option value="<?php echo $data1->id_kabupaten?>"><?php echo $data1->nama_kabupaten?></option>
																				<?php }
																				} ?>
																			</select>
																		...
																		<div class="form-group">
																			...
																			<select id="kecamatan_desa"  class="form-control" required="" aria-required="true" required name="kecamatan">
																				...
																				<?php foreach($kecamatan as $data1){
																					if($data->id_kecamatan!=$data1->id_kecamatan){
																					?>
																				<option value="<?php echo $data1->id_kecamatan?>"><?php echo $data1->nama_kecamatan?></option>
																				<?php }
																				} ?>
																			</select>
																		...
																		<div class="form-group">
																			...
																			<div class="col-sm-10">
																				<input type="text" class="form-control" id="Username5" value="<?php echo $data->nama_desa?>" name="nama_desa" required autofocus><div class="form-control-line"></div>
																			</div>
																		</div>
																...
																<table <?php $link=$_GET['id']; if($link =="5"){ echo 'id="datatable1"';} ?> class="table table-striped table-hover">
																	...
																	<tbody>
																		...
																		<tr class="gradeX">
																			<td><?php echo ++$j?></td>
																			<td><?php echo $data->nama_desa; ?></td>
																			<td><a href="<?php echo base_url()?>edit_alamat?id=5&&id_kabupaten=0&&id_kecamatan=0&&id_desa=<?php echo $data->id_desa?>"  ><button type="button" class="btn ink-reaction btn-raised btn-primary">Edit</button></a></td>
																			<?php
